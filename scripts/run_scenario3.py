"""Run scenario3 with basic, restart, SA, and DL configs; print comparison."""
import csv
import sys
...
SCENARIO_PATH = _project_root / "scenarios" / "scenario3.txt"
...
def main():
    ...
    configs = [
        ...
        ("all", replace(base, use_restart=True, use_sa=True, use_dimlearn=True, init_avoid_obstacles=True, init_line_prob=0.5, vmax=30)),
    ]
    print("=" * 55)
